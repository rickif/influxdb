...
// // ensure *InmemKVStore implement kv.SchemaStore interface
// var _ kv.SchemaStore = (*InmemKVStore)(nil)

// // cursorBatchSize is the size of a batch sent by a forward cursors
// // tree iterator
// const cursorBatchSize = 1000

// // InmemKVStore is an in memory btree backed kv.Store.
...
// // NewInmemKVStore creates an instance of a InmemKVStore.
...
// func (s *InmemKVStore) View(ctx context.Context, fn func(kv.Tx) error) error {
// 	s.mu.RLock()
// 	defer s.mu.RUnlock()
...
// func (s *InmemKVStore) Update(ctx context.Context, fn func(kv.Tx) error) error {
// 	s.mu.Lock()
// 	defer s.mu.Unlock()
...
// // does not exist.
// func (s *InmemKVStore) CreateBucket(ctx context.Context, name []byte) error {
// 	s.mu.Lock()
// 	defer s.mu.Unlock()
...
// // does not exist.
// func (s *InmemKVStore) DeleteBucket(ctx context.Context, name []byte) error {
// 	s.mu.Lock()
// 	defer s.mu.Unlock()
...
// func (s *InmemKVStore) Backup(ctx context.Context, w io.Writer) error {
// 	panic("not implemented")
// }

// // Flush removes all data from the buckets.  Used for testing.
// func (s *InmemKVStore) Flush(ctx context.Context) {
// 	s.mu.Lock()
// 	defer s.mu.Unlock()
...
// // Buckets returns the names of all buckets within inmem.InmemKVStore.
// func (s *InmemKVStore) Buckets(ctx context.Context) [][]byte {
// 	s.mu.RLock()
// 	defer s.mu.RUnlock()
